...
import com.luciferche.lukmeup.R;
...
public class DriverActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        super.onResume();
        updateButtonsState(LocationUtils.getRequestingLocationUpdates(this));
...
//        return PendingIntent.getBroadcast(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        if (s.equals(LocationUtils.KEY_LOCATION_UPDATES_RESULT)) {
            mLocationUpdatesResultView.setText(LocationUtils.getLocationUpdatesResult(this));
        } else if (s.equals(LocationUtils.KEY_LOCATION_UPDATES_REQUESTED)) {
            updateButtonsState(LocationUtils.getRequestingLocationUpdates(this));
        }
    }
